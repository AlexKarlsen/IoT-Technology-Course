...
\begin{lstlisting}[language=Python, caption=Node.js MQTT, label={lst:nodemqtt}]
...
\begin{lstlisting}[language=Python, caption=Node.js REST API Routes, label={lst:routes}]
    ...
    var baseurl = '/service';
...
\begin{lstlisting}[language=Python, caption=Server Sent Event, label={lst:sse}]
